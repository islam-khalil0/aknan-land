  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 justify-center items-center my-[4rem] max-md:my-[2rem] px-[7rem] max-md:px-[1.5rem]">
        <div
          className="flex flex-col items-center justify-center gap-6 w-full max-w-6xl rounded-[20px] py-16 px-6 text-center shadow-[0_0_80px_-10px_rgba(82,39,255,0.4)]"
          style={{
